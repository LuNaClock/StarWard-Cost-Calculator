...
export const considerPartnerCAwakeningCheckbox = document.getElementById('considerPartnerCAwakeningCheckbox');
export const partnerCAwakeningOptionsContainer = document.getElementById('partnerCAwakeningOptionsContainer');
export const partnerCAwakeningBonusSelect = document.getElementById('partnerCAwakeningBonusSelect');
...
export const awakeningDetailPartnerCAwakeningValue = document.getElementById('awakeningDetailPartnerCAwakeningValue');
export const awakeningDetailPartnerCAwakeningStatus = document.getElementById('awakeningDetailPartnerCAwakeningStatus');
